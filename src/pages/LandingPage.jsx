    ...
    return (
        <div className="bg-white">
            ...
            <main>
                ...
                <section className="w-full mt-[9rem]">
                ...
                <section className="bg-[#FBFBFB] pt-16 pb-24 sm:pb-28">
                        ...
                        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
                            <div className="grid gap-10 border-b border-slate-200 py-12 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
                                <div>
                                    ...
                                    <p className="mt-4 max-w-xs text-sm leading-6 text-slate-500">
                                        Lorem ipsum dolor sit amet consectetur.
                                        Porta arcu commodo purus pellentesque
                                        commodo amet clim ac.
                                    </p>
                                </div>
                            ...
                            <div className="flex flex-col gap-6 py-6 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <div className="text-xs text-slate-400">
                                    Copyright © 2025 ijustpaid. All rights
                                    reserved.
                                </div>
                            </div>
                        </div>
